#include "headers/qtWindowCode/mainwindow.h"
...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) {
    ...
    QString imageFolderPath = QString::fromStdString(fs::absolute("assets/games").string());  // Path to the local images folder

    for (int i = 0; i < 2; ++i) {
        QLabel *imageLabel = new QLabel(this);

        // Build the image path dynamically
        QString filePath = imageFolderPath + QString("/game%1.png").arg(i + 1);
...
void MainWindow::openAlternateWindow(int index) {
    ...
    switch(index){
    case 0:
        tabName = "Pokemon Champions";
        break;
    case 1:
        tabName = "Pokemon Scarlet and Violet";
        break;
    default:
        tabName = "TBD";
    }
...
void MainWindow::checkForUpdates() {
    QString currentVersion = "0.0.0";

    // Replace with actual owner and repo
    QString owner = "JGDC";
    QString repo = "VGC-Calculator";
